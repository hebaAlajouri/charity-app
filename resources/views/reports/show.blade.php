<x-app-layout>
    ...
    {{ __('report_details.title') }}
</h2>

         <div class="mb-4 text-right">
    <span class="text-[#C9B458] font-semibold">{{ __('report_details.category') }}:</span>
    <span class="text-[#2C3E50]">{{ $report->category ?? __('report_details.not_defined') }}</span>
</div>
    ...
    <a href="{{ route('reports.index') }}"
       class="inline-block text-[#7EB6C1] font-medium text-sm hover:underline">
        {{ __('report_details.back_to_reports') }}
    </a>
</div>
        </div>
    </div>
