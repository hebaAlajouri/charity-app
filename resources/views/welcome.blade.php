   ...
   <section class="featured-projects">
    ...
    <div class="about-container">
        <div class="about-content">
            ...
            <p>منذ تأسيسنا، تمكنا من كفالة آلاف الأطفال وتقديم الدعم لعائلاتهم. نؤمن بأن كل طفل يستحق فرصة في الحياة وأن المجتمع مسؤول عن رعاية أطفاله.</p>
        </div>
